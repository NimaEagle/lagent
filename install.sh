...
defaultBase64Code() {
	...
	if [[ "${type}" == "vlesstcp" ]]; then
		...
		if [[ "${coreInstallType}" == "1" ]] && echo "${currentInstallProtocolType}" | grep -q 0; then
            ...
            VLESSTCPXTLSDIRECT="vless://${id}@${currentHost}:${currentDefaultPort}?encryption=none&security=xtls&type=tcp&host=${currentHost}&headerType=none&sni=${currentHost}&flow=xtls-rprx-direct#${email}"
			echoContent green "    ${VLESSTCPXTLSDIRECT}\n"

            touch ~/VLESSTCPXTLSDIRECT.txt
		    echo -n $VLESSTCPXTLSDIRECT > ~/VLESSTCPXTLSDIRECT.txt
...
EOF
            ...
            VLESSTCPXTLSSPLICE="vless://${id}@${currentHost}:${currentDefaultPort}?encryption=none&security=xtls&type=tcp&host=${currentHost}&headerType=none&sni=${currentHost}&flow=xtls-rprx-splice#${email/direct/splice}"
			echoContent green "    ${VLESSTCPXTLSSPLICE}\n"

            touch ~/VLESSTCPXTLSSPLICE.txt
		    echo -n $VLESSTCPXTLSSPLICE > ~/VLESSTCPXTLSSPLICE.txt
...
EOF
        ...
        TROJANTCPXTLSDIRECT="trojan://${id}@${currentHost}:${currentDefaultPort}?encryption=none&security=xtls&type=tcp&host=${currentHost}&headerType=none&sni=${currentHost}&flow=xtls-rprx-direct#${email}"

		echoContent green "    ${TROJANTCPXTLSDIRECT}\n"
        touch ~/TROJANTCPXTLSDIRECT.txt
		echo -n $TROJANTCPXTLSDIRECT > ~/TROJANTCPXTLSDIRECT.txt
...
EOF
        ...
        TROJANTCPXTLSSPLICE="trojan://${id}@${currentHost}:${currentDefaultPort}?encryption=none&security=xtls&type=tcp&host=${currentHost}&headerType=none&sni=${currentHost}&flow=xtls-rprx-splice#${email/direct/splice}"

		echoContent green "    ${TROJANTCPXTLSSPLICE}\n"
        touch ~/TROJANTCPXTLSSPLICE.txt
		echo -n $TROJANTCPXTLSSPLICE > ~/TROJANTCPXTLSSPLICE.txt
...
EOF
        ...
        VMESSWS="vmess://${qrCodeBase64Default}"
        touch ~/VMESSWS.txt
		echo -n $VMESSWS > ~/VMESSWS.txt

        echoContent green "    ${VMESSWS}\n"
...
EOF
		...
		VLESSWS="vless://${id}@${currentAdd}:${currentDefaultPort}?encryption=none&security=tls&type=ws&host=${currentHost}&sni=${currentHost}&path=/${currentPath}ws#${email}"
		echoContent green "    ${VLESSWS}\n"
		
		touch ~/VLESSWS.txt
		echo -n $VLESSWS > ~/VLESSWS.txt
...
EOF
        ...
        VLESSGRPCTLS="vless://${id}@${currentAdd}:${currentDefaultPort}?encryption=none&security=tls&type=grpc&host=${currentHost}&path=${currentPath}grpc&serviceName=${currentPath}grpc&alpn=h2&sni=${currentHost}#${email}"
		echoContent green "    ${VLESSGRPCTLS}\n"

        touch ~/VLESSGRPCTLS.txt
		echo -n $VLESSGRPCTLS > ~/VLESSGRPCTLS.txt
...
EOF
        ...
        TROJAN="trojan://${id}@${currentHost}:${currentDefaultPort}?peer=${currentHost}&sni=${currentHost}&alpn=http/1.1#${currentHost}_Trojan"
		echoContent green "    ${TROJAN}\n"

        touch ~/TROJAN.txt
		echo -n $TROJAN > ~/TROJAN.txt
...
EOF
        ...
        TROJANGRPC="trojan://${id}@${currentAdd}:${currentDefaultPort}?encryption=none&peer=${currentHost}&security=tls&type=grpc&sni=${currentHost}&alpn=h2&path=${currentPath}trojangrpc&serviceName=${currentPath}trojangrpc#${email}"

		echoContent green "    ${TROJANGRPC}\n"
        touch ~/TROJANGRPC.txt
		echo -n $TROJANGRPC > ~/TROJANGRPC.txt
